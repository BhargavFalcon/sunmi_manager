                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Icon(
                                      ...
                                      size: MySize.getHeight(16.0),
                                      color: Colors.black.withValues(
                                        alpha: 0.6,
                                      ),
                                    ),
                                    SizedBox(width: MySize.getWidth(4.0)),
                                    Text(
                          ...
                          SizedBox(height: MySize.getHeight(10.0)),
                          Row(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        SizedBox(width: MySize.getWidth(2.0)),
                                        InkWell(
                                          onTap: () {
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        Container(
                                          padding: EdgeInsets.symmetric(
                                            horizontal: MySize.getWidth(8.0),
                                            vertical: MySize.getHeight(4.0),
                                          ),
                                          decoration: BoxDecoration(
                                            color: Color(
                                              0xFF10B981,
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Icon(
                                                Icons.check_circle,
                                                size: MySize.getHeight(12.0),
                                                color: Color(0xFF10B981),
                                              ),
                                              SizedBox(
                                                width: MySize.getWidth(4.0),
                                              ),
                                              Text(
                                    ...
                                    Text(
                                      TranslationKeys
                                          ...
                                          .tr,
                                      style: TextStyle(
                                        fontSize: MySize.getHeight(12.0),
                                        fontWeight: FontWeight.normal,
                                        color: Colors.grey.shade600,
                                      ),
                                    ),
