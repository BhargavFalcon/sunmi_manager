...
class LocaleString extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'en_US': {
      ...
      'pleaseEnterVoucherCode': 'Please enter voucher code',
      'coupon': 'Coupon',
      'tip': 'Tip',
      'tax': 'Tax',
      'taxes': 'Taxes',
      ...
      'shopControls': 'Shop Controls',
      'onOffDesc': 'Enable or disable new orders when your restaurant is busy.',
      'scheduleDesc':
      ...
      'netOfDue': 'Net of Due',
      'dueOutstanding': 'Due Outstanding',
      ...
      'cancelAndRefundQuestion': 'Cancel & Refund?',
      'cancelAndRefundConfirmation':
          'Are you sure you want to cancel this order? Any associated payments will be refunded.',
      'additionalCommentOptional': 'Additional Comment (Optional)',
      ...
      'errorInPrinting': 'Error in printing',
      ...
      'internalSunmiPrinter': 'Internal Sunmi Printer',
      'connectedAndReady': 'Connected & Ready',
      'verificationFailed': 'Verification failed',
      'serverReturned': 'Server returned',
      'printerSelected': 'Printer "%s" selected',
      'paymentReceiptHeader': 'Amount Payment Method   Date & Time',
      ...
      'refundAmountExceedsAvailable':
          'Refund amount cannot be more than the available refund amount',
    ...
    'da_DK': {
      ...
      'beepSound': 'Bip-lyd',
      'newShopOrderNotifications': 'Giv besked om nye butiksordrer',
      ...
      'quickControlsOnly':
          'Kun hurtig kontrol. Fuldstændige indstillinger er tilgængelige på webdashboardet.',
      'minutes': 'Minutter',
      'todaySummary': 'Dagsoversigt',
      'period': 'Periode',
      'timezone': 'Tidszone',
      'end': 'Slut',
      'generatedAt': 'Genereret kl.',
      'totalOrders': 'Ordrer i alt',
      'paidOrders': 'Betalte ordrer',
      'countedOrders': 'Optalte ordrer',
      'cancelledOrders': 'Annullerede ordrer',
      'ongoing': 'I gang',
      'ongoingAmount': 'Igangværende beløb',
      'byOrderType': 'Efter ordretype',
      'byStatus': 'Efter status',
      'sales': 'Salg',
      'gross': 'Brutto',
      'taxesByRate': 'Moms pr. sats',
      'nameRate': 'Navn (Sats)',
      'net': 'Netto',
      'discounts': 'Rabatter',
      'tips': 'Drikkepenge',
      'orderLevel': 'Ordreniveau',
      'paymentLevel': 'Betalingsniveau',
      'salesByType': 'Salg efter type',
      'payments': 'Betalinger',
      'totalCollected': 'Samlet modtaget',
      'netOfDue': 'Netto forfaldent',
      'dueOutstanding': 'Udestående (forfaldent)',
      'awaitingVerification': 'Afventer bekræftelse',
      'byMethod': 'Efter metode',
      'printed': 'Udskrevet',
      'count': 'Antal',
      'vouchers': 'Værdikuponer',
      'rate': 'Sats',
      'type': 'Type',
      'method': 'Metode',
      'cancelAndRefund': 'Annuller & refunder',
      'cancelAndRefundQuestion': 'Annuller & refunder?',
      'cancelAndRefundConfirmation':
          'Er du sikker på, at du vil annullere denne bestilling? Eventuelle tilknyttede betalinger vil blive refunderet.',
      'additionalCommentOptional': 'Yderligere kommentar (valgfrit)',
      'logout': 'Log ud',
      ...
      'printSuccessful': 'Print gennemført',
      'errorInPrinting': 'Fejl under udskrivning',
      ...
      'allSplitItemsWillBeCleared': 'Alle opdelte elementer vil blive slettet.',

      // Printing & Localization Refinement
      'internalSunmiPrinter': 'Intern Sunmi-printer',
      'connectedAndReady': 'Tilsluttet og klar',
      'verificationFailed': 'Bekræftelse mislykkedes',
      'serverReturned': 'Server svarede',
      'printerSelected': 'Printer "%s" valgt',
      'paymentReceiptHeader': 'Beløb Betalingsmetode   Dato og tid',
      'deliveryChargeLabel': 'Leveringsgebyr:',
      ...
      'by': 'af',
      'createRefund': 'Opret refundering',
      'alreadyRefunded': 'Allerede refunderet',
      'availableToRefund': 'Tilgængelig til refundering',
      'reasonOptional': 'Årsag (valgfri)',
      'enterReason': 'Indtast årsag...',
      'enterValidRefundAmount': 'Indtast et gyldigt refunderingsbeløb',
      'refundAmountExceedsAvailable':
          'Refunderingsbeløbet må ikke være større end det tilgængelige beløb',
      'orderDelivered': 'Leveret',
      'packagingCharge': 'Emballagegebyr',
      'itemDeposit': 'Pant',
      'voucher': 'Værdikupon',
      'id': 'ID',
    ...
    'de_DE': {
      ...
      'beepSound': 'Piepton',
      'newShopOrderNotifications': 'Neue Shop-Bestellbenachrichtigungen',
      ...
      'quickControlsOnly':
          'Nur Schnellwahl-Steuerungen. Vollständige Einstellungen sind im Web-Dashboard verfügbar.',
      'minutes': 'Minuten',
      ...
      'countedOrders': 'Gezählte Bestellungen',
      'cancelledOrders': 'Stornierte Bestellungen',
      'ongoing': 'Laufend',
      'ongoingAmount': 'Laufender Betrag',
      'byOrderType': 'Nach Bestelltyp',
      'byStatus': 'Nach Status',
      'sales': 'Verkäufe',
      'gross': 'Brutto',
      'taxesByRate': 'Steuern nach Satz',
      'nameRate': 'Name (Satz)',
      'net': 'Netto',
      'discounts': 'Rabatte',
      'tips': 'Trinkgeld',
      'orderLevel': 'Bestellebene',
      'paymentLevel': 'Zahlungsebene',
      'salesByType': 'Verkäufe nach Typ',
      'payments': 'Zahlungen',
      'totalCollected': 'Gesamt eingenommen',
      'netOfDue': 'Netto fällig',
      'dueOutstanding': 'Ausstehend (fällig)',
      'awaitingVerification': 'Wartet auf Bestätigung',
      ...
      'type': 'Typ',
      'method': 'Methode',
      'cancelAndRefund': 'Stornieren & erstatten',
      'cancelAndRefundQuestion': 'Stornieren & erstatten?',
      'cancelAndRefundConfirmation':
          'Sind Sie sicher, dass Sie diese Bestellung stornieren möchten? Alle zugehörigen Zahlungen werden erstattet.',
      'additionalCommentOptional': 'Zusätzlicher Kommentar (optional)',
      'logout': 'Abmelden',
      ...
      'errorInPrinting': 'Fehler beim Drucken',
      ...
      // Printing & Localization Refinement
      'internalSunmiPrinter': 'Interner Sunmi-Drucker',
      'connectedAndReady': 'Verbunden & Bereit',
      'verificationFailed': 'Verifizierung fehlgeschlagen',
      'serverReturned': 'Server antwortete',
      'printerSelected': 'Drucker "%s" ausgewählt',
      'paymentReceiptHeader': 'Betrag Zahlungsmethode   Datum & Uhrzeit',
      'deliveryChargeLabel': 'Liefergebühr:',
      ...
      'availableToRefund': 'Zur Erstattung verfügbar',
      'reasonOptional': 'Grund (optional)',
      'enterReason': 'Grund eingeben...',
      'enterValidRefundAmount':
          'Bitte einen gültigen Erstattungsbetrag eingeben',
      'refundAmountExceedsAvailable':
          'Der Erstattungsbetrag darf nicht höher als der verfügbare Betrag sein',
    ...
    'nl_NL': {
      ...
      'quickControlsOnly':
          'Alleen snelbediening. Volledige instellingen beschikbaar op het webdashboard.',
      'minutes': 'Minuten',
      'todaySummary': 'Dagoverzicht',
      'period': 'Periode',
      'timezone': 'Tijdzone',
      'end': 'Einde',
      ...
      'countedOrders': 'Getelde bestellingen',
      'cancelledOrders': 'Geannuleerde bestellingen',
      'ongoing': 'Lopend',
      'ongoingAmount': 'Lopend bedrag',
      'byOrderType': 'Op bestellingstype',
      'byStatus': 'Op status',
      'sales': 'Omzet',
      'gross': 'Bruto',
      'taxesByRate': 'Belasting per tarief',
      'nameRate': 'Naam (Tarief)',
      'net': 'Netto',
      'discounts': 'Kortingen',
      'tips': 'Fooien',
      'orderLevel': 'Bestelniveau',
      'paymentLevel': 'Betalingsniveau',
      'salesByType': 'Verkopen per type',
      'payments': 'Betalingen',
      'totalCollected': 'Totaal ontvangen',
      'netOfDue': 'Netto verschuldigd',
      'dueOutstanding': 'Uitstaand (verschuldigd)',
      'awaitingVerification': 'Wachten op verificatie',
      'byMethod': 'Per methode',
      'printed': 'Afgedrukt',
      'count': 'Aantal',
      'vouchers': 'Vouchers',
      'rate': 'Tarief',
      'type': 'Type',
      'method': 'Methode',
      'cancelAndRefund': 'Annuleren & terugbetalen',
      'cancelAndRefundQuestion': 'Annuleren & terugbetalen?',
      'cancelAndRefundConfirmation':
          'Weet u zeker dat u deze bestelling wilt annuleren? Eventuele gekoppelde betalingen worden terugbetaald.',
      'additionalCommentOptional': 'Aanvullende opmerking (optioneel)',
      'logout': 'Uitloggen',
      ...
      'printSuccessful': 'Print succesvol',
      'errorInPrinting': 'Fout bij printen',
      ...
      // Printing & Localization Refinement
      'internalSunmiPrinter': 'Interne Sunmi-printer',
      'connectedAndReady': 'Verbonden en klaar',
      'verificationFailed': 'Verificatie mislukt',
      'serverReturned': 'Server retourneerde',
      'printerSelected': 'Printer "%s" geselecteerd',
      'paymentReceiptHeader': 'Bedrag Betaalmethode   Datum & Tijd',
      'deliveryChargeLabel': 'Bezorgkosten:',
      ...
      'by': 'door',
      'createRefund': 'Terugbetaling aanmaken',
      'alreadyRefunded': 'Al terugbetaald',
      'availableToRefund': 'Beschikbaar voor terugbetaling',
      'reasonOptional': 'Reden (optioneel)',
      'enterReason': 'Voer reden in...',
      'enterValidRefundAmount': 'Voer een geldig terugbetalingsbedrag in',
      'refundAmountExceedsAvailable':
          'Het terugbetalingsbedrag mag niet hoger zijn dan het beschikbare bedrag',
      'orderDelivered': 'Bezorgd',
      'packagingCharge': 'Verpakkingskosten',
      'itemDeposit': 'Statiegeld',
      'voucher': 'Voucher',
      'id': 'ID',
